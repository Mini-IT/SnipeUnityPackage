...
{
	public class SnipeTableCalendarItemsWrapper : SnipeTableItemsListWrapper<SnipeTableCalendarItem>
	{
		public static SnipeTableCalendarItemsWrapper FromTableData(IDictionary<string, object> table_data)
		{
