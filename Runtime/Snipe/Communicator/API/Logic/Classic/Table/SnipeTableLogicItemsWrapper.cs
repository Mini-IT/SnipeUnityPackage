...
{
	public class SnipeTableLogicItemsWrapper : SnipeTableItemsListWrapper<SnipeTableLogicItem>
	{
		public static SnipeTableLogicItemsWrapper FromTableData(IDictionary<string, object> table_data)
		{
