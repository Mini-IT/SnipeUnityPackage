...
{
	internal sealed class NullAnalyticsTracker : ISnipeCommunicatorAnalyticsTracker
	{
		...
		public bool CheckErrorCodeTracking(string messageType, string errorCode) => false;
	}
}
